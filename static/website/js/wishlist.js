...
function getWishlists() {
  ...
  if (!userData.isLoggedIn) {
    ...
    for (var i = 0; i < userData.wishlists.length; i++) {
      if (i == 0) {
        var template = "\n                        <li class=\"is-active\" data-target-wishlist=\"wishlist-".concat(userData.wishlists[i].id, "\" data-wishlist-id=\"").concat(userData.wishlists[i].id, "\">\n                            <a>").concat(userData.wishlists[i].name, "</a>\n                            <div class=\"action-block\">\n                                <span>").concat(userData.wishlists[i].products.length, " items</span>\n                                <button class=\"remove-button remove-wishlist-action\">\n                                    ").concat(trashIcon, "\n                                </button>\n                            </div>\n                        </li>\n                    ");
        var listContainer = "\n                        <ul id=\"wishlist-".concat(userData.wishlists[i].id, "\" class=\"wishlist\"></ul>\n                    ");
      } else {
        var template = "\n                        <li data-target-wishlist=\"wishlist-".concat(userData.wishlists[i].id, "\" data-wishlist-id=\"").concat(userData.wishlists[i].id, "\">\n                            <a>").concat(userData.wishlists[i].name, "</a>\n                            <div class=\"action-block\">\n                                <span>").concat(userData.wishlists[i].products.length, " items</span>\n                                <button class=\"remove-button remove-wishlist-action\">\n                                    ").concat(trashIcon, "\n                                </button>\n                            </div>\n                        </li>\n                    ");
        var listContainer = "\n                        <ul id=\"wishlist-".concat(userData.wishlists[i].id, "\" class=\"wishlist is-hidden\"></ul>\n                    ");
      }
    ...
    for (var w = 0; w < userData.wishlists.length; w++) {
      for (var t = 0; t < userData.wishlists[w].products.length; t++) {
        var template = "\n                        <li class=\"wishlist-item product-container\" onclick=\"return true\" data-wishlist-id=\"".concat(userData.wishlists[w].id, "\"\n                            data-product-id=\"").concat(userData.wishlists[w].products[t].id, "\">\n                            <div class=\"item-wrapper\">\n                                <!-- Product Image -->\n                                <img src=\"http://via.placeholder.com/500x500/ffffff/999999\" data-demo-src=\"").concat(userData.wishlists[w].products[t].images[0].url, "\" alt=\"\">\n                                <!-- Product meta -->\n                                <span class=\"product-info\">\n                                    <a class=\"product-name\">").concat(userData.wishlists[w].products[t].name, "</a>\n                                    <span>").concat(userData.wishlists[w].products[t].category, "</span>\n                                    <span class=\"product-price is-hidden\"><span>").concat(userData.wishlists[w].products[t].price, "</span></span>\n                                </span>\n                                <div class=\"action\">\n                                    <!-- actions -->\n                                    <a class=\"add-button whishlist-cart-button pop-button\">\n                                        <div class=\"add-button-inner\">\n                                            ").concat(cartIcon, "\n                                        </div>\n                                    </a>\n                                    <a class=\"remove-button remove-wishlist-item-action\">\n                                        <div class=\"remove-button-inner\">\n                                            ").concat(trashIcon, "\n                                        </div>\n                                    </a>\n                                </div>\n                            </div>\n                        </li>\n                    ");
...
function loadWishlistsInModal() {
  ...
  if (userData.wishlists.length === 0) {
    ...
    for (var i = 0; i < userData.wishlists.length; i++) {
      if (i == 0) {
        var template = "\n                    <li class=\"list-item is-active\" data-wishlist-id=\"".concat(userData.wishlists[i].id, "\">\n                        <div class=\"meta\">\n                            <span class=\"name\">").concat(userData.wishlists[i].name, "</span>\n                            <span class=\"count\"><var>").concat(userData.wishlists[i].products.length, "</var> Items</span>\n                        </div>\n                        <div class=\"selected-indicator\">\n                            ").concat(checkIcon, "\n                        </div>\n                    </li>\n                ");
      } else {
        var template = "\n                    <li class=\"list-item\" data-wishlist-id=\"".concat(userData.wishlists[i].id, "\">\n                        <div class=\"meta\">\n                            <span class=\"name\">").concat(userData.wishlists[i].name, "</span>\n                            <span class=\"count\"><var>").concat(userData.wishlists[i].products.length, "</var> Items</span>\n                        </div>\n                        <div class=\"selected-indicator\">\n                            ").concat(checkIcon, "\n                        </div>\n                    </li>\n                ");
      }
