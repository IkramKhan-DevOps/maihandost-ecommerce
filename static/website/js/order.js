      ...
      for (var i = 0; i < data.length; i++) {
        if (data[i].id === orderId) {
          ...
          for (var p = 0; p < data[i].products.length; p++) {
            var template = "\n                            <div class=\"flex-table-item product-container\" data-product-id=\"".concat(data[i].products[p].id, "\">\n                                <div class=\"product\">\n                                    <img src=\"http://via.placeholder.com/250x250\" data-demo-src=\"").concat(data[i].products[p].photoUrl, "\" alt=\"\">\n                                    <a class=\"product-details-link product-name\">").concat(data[i].products[p].name, "</a>\n                                </div>\n                                <div class=\"quantity\">\n                                    <span>").concat(data[i].products[p].quantity, "</span>\n                                </div>\n                                <div class=\"price\">\n                                    <span class=\"has-price\">").concat(data[i].products[p].price.toFixed(2), "</span>\n                                </div>\n                                <div class=\"discount\">\n                                    <span class=\"has-price\">0</span>\n                                </div>\n                                <div class=\"total\">\n                                    <span class=\"has-price\">").concat((data[i].products[p].price * data[i].products[p].quantity).toFixed(2), "</span>\n                                </div>\n                            </div>\n                        ");
            $.when($('.flex-table').append(template)).done(function () {
              //Make product links clickable
              initOrderDetailsLinks(); //DEMO
