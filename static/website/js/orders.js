...
function getOrdersGrid() {
  ...
  if (!userData.isLoggedIn) {
    ...
    for (var i = 0; i < userData.orders.length; i++) {
      ...
      var template = "\n                <div class=\"column is-4\">\n                    <div class=\"flat-card order-card has-popover-top\" data-order-id=\"".concat(userData.orders[i].id, "\">\n                        <div class=\"order-info\">\n                            <span><a class=\"order-details-link\" onclick=\"return true\">ORDER-").concat(userData.orders[i].id, "</a></span>\n                            <span class=\"tag ").concat(modifierClass, "\">").concat(userData.orders[i].status, "</span>\n                        </div>\n                        <!-- Progress Circle -->\n                        <div class=\"circle-chart-wrapper\">\n                            <svg class=\"circle-chart\" viewbox=\"0 0 33.83098862 33.83098862\" width=\"140\" height=\"140\" xmlns=\"http://www.w3.org/2000/svg\">\n                                <circle class=\"circle-chart-background\" stroke=\"#efefef\" stroke-width=\"2\" fill=\"none\" cx=\"16.91549431\" cy=\"16.91549431\" r=\"15.91549431\" />\n                                <circle class=\"circle-chart-circle\" stroke=\"").concat(primaryColor, "\" stroke-width=\"2\" stroke-dasharray=\"").concat(userData.orders[i].completed, ",100\" stroke-linecap=\"round\" fill=\"none\" cx=\"16.91549431\" cy=\"16.91549431\" r=\"15.91549431\" />\n                            </svg>\n                            <!-- Icon -->\n                            <div class=\"chart-icon\">\n                                ").concat(icon, "\n                            </div>\n                            <!-- Label -->\n                            <div class=\"ring-title has-text-centered\">\n                                <span>").concat(userData.orders[i].completed, "% Complete</span>\n                            </div>\n                        </div>\n                    </div>\n\n                    <div class=\"webui-popover-content\">\n                        <!-- Popover Block -->\n                        <div class=\"popover-flex-block\">\n                            <img class=\"staff-avatar\" src=\"http://via.placeholder.com/250x250\" data-demo-src=\"").concat(userData.orders[i].contact.photoUrl, "\" alt=\"\">\n                            <div class=\"content-block\">\n                                <label>Order handled by</label>\n                                <span>").concat(userData.orders[i].contact.name, "</span>\n                            </div>\n                        </div>\n                        <!-- Popover Block -->\n                        <div class=\"popover-flex-block\">\n                            <div class=\"icon-block\">\n                                ").concat(clockIcon, "\n                            </div>\n                            <div class=\"content-block\">\n                                <label>Ordered on</label>\n                                <span>").concat(userData.orders[i].date, "</span>\n                            </div>\n                        </div>\n                        <!-- Popover Block -->\n                        <div class=\"popover-flex-block\">\n                            <div class=\"icon-block\">\n                                ").concat(ccIcon, "\n                            </div>\n                            <div class=\"content-block\">\n                                <label>Order Total</label>\n                                <span>").concat(userData.orders[i].total, "</span>\n                            </div>\n                        </div>\n                        <!-- Popover Block -->\n                        <div class=\"popover-flex-block\">\n                            <div class=\"icon-block\">\n                                ").concat(truckIcon, "\n                            </div>\n                            <div class=\"content-block\">\n                                <label>Shipping Method</label>\n                                <span>").concat(userData.orders[i].shippingMethod, "</span>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            ");
...
function getOrdersList() {
  ...
  if (!userData.isLoggedIn) {
    ...
    for (var i = 0; i < userData.orders.length; i++) {
      ...
      var template = "\n                <div class=\"order-long-card\" data-order-id=\"".concat(userData.orders[i].id, "\">\n                    <div class=\"left-side\">\n                        <div class=\"order-header\">\n                            <h3>ORDER ").concat(userData.orders[i].id, "</h3>\n                            <span class=\"date\">").concat(userData.orders[i].date, "</span>\n                            <span class=\"tag is-primary\">").concat(userData.orders[i].status, "</span>\n                            <span class=\"order-total\">").concat(userData.orders[i].total, "</span>\n                        </div>\n                        <div class=\"ordered-products has-slimscroll\">\n                            <!--Loader-->\n                            <div class=\"products-loader is-active\">\n                                <div class=\"loader is-loading\"></div>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"right-side\">\n                        <img class=\"side-bg\" src=\"assets/img/logo/nephos-greyscale.svg\" alt=\"\">\n                        <div class=\"meta-header\">\n                            <img src=\"http://via.placeholder.com/250x250\" data-demo-src=\"").concat(userData.orders[i].contact.photoUrl, "\" alt=\"\">\n                            <div class=\"inner-meta\">\n                                <span>Handled by</span>\n                                <span>").concat(userData.orders[i].contact.name, "</span>\n                            </div>\n                            <a class=\"support\">\n                                ").concat(supportIcon, "\n                            </a>\n                        </div>\n\n                        <div class=\"meta-actions\">\n                            <a class=\"button is-rounded is-fullwidth primary-button raised order-details-link\">Order Details</a>\n                            <a class=\"button is-rounded is-fullwidth grey-button rounded\">Invoice</a>\n                        </div>\n                    </div>\n                </div>\n            ");
...
function loadOrdersListProducts() {
  ...
  $('.order-long-card').each(function () {
    ...
    for (var p = 0; p < products.length; p++) {
      var template = "\n                        <div class=\"ordered-product\">\n                            <img src=\"http://via.placeholder.com/250x250\" data-demo-src=\"".concat(products[p].photoUrl, "\" alt=\"\">\n                            <div class=\"product-meta\">\n                                <span class=\"name\">").concat(products[p].name, "</span>\n                                <span class=\"price\">\n                                    <span>").concat(parseFloat(products[p].price).toFixed(2), "</span>\n                                    <span>x <var>").concat(products[p].quantity, "</var></span>\n                                </span>\n                            </div>\n                            <div class=\"product-subtotal\">\n                                <span>Total</span>\n                                <span>").concat((parseFloat(products[p].price) * parseFloat(products[p].quantity)).toFixed(2), "</span>\n                            </div>\n                        </div>\n                    ");
