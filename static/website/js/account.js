...
function getAccountInfo() {
  ...
  if (!userData.isLoggedIn) {
    ...
    //Photo
    $('.profile-image').empty();
    var avatar = "\n        <img src=\"http://via.placeholder.com/250x250\" data-demo-src=\"".concat(userData.photoUrl, "\" alt=\"\">\n    ");
...
function getEditAccountInfo() {
  ...
  if (!userData.isLoggedIn) {
    ...
    var avatar = "\n        <img class=\"profile-pic\" src=\"http://via.placeholder.com/250x250\" data-demo-src=\"".concat(userData.photoUrl, "\" alt=\"\">\n    ");
