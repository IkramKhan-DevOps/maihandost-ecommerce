...
function getCart() {
  ...
  if (data.products.length > 0) {
    ...
    for (var i = 0; i < data.products.length; i++) {
      ...
      var template = "\n                <li class=\"clearfix product-container\" data-product-id=\"".concat(data.products[i].id, "\">\n                    <img src=\"http://via.placeholder.com/250x250\" data-demo-src=\"").concat(data.products[i].images[0].url, "\"  alt=\"\" />\n                    <span class=\"item-meta\">\n                        <span class=\"item-name\">").concat(data.products[i].name, "</span>\n                        <span class=\"item-price\">\n                            <var>").concat(parseFloat(data.products[i].price).toFixed(2), "</var> x <span>").concat(data.products[i].quantity, "</span>\n                        </span>\n                    </span>\n                    <span class=\"quantity\">\n                        <div id=\"spinner-").concat(data.products[i].id, "\" data-trigger=\"spinner\" class=\"sidebar-spinner\">\n                            <input class=\"hidden-spinner\" type=\"hidden\" value=\"").concat(data.products[i].quantity, "\" data-spin=\"spinner\"\n                                data-rule=\"quantity\" data-min=\"1\" data-max=\"99\">\n                            <a class=\"spinner-button is-remove\" href=\"javascript:;\" data-spin=\"down\">\n                                ").concat(minusIcon, "\n                            </a>\n                            <span class=\"spinner-value\">").concat(data.products[i].quantity, "</span>\n                            <a class=\"spinner-button is-add\" href=\"javascript:;\" data-spin=\"up\">\n                                ").concat(plusIcon, "\n                            </a>\n                        </div>\n                    </span>\n\n                    <span class=\"remove-item remove-from-cart-action has-simple-popover\" data-content=\"Remove from Cart\" data-placement=\"top\" onclick=\"return false\">\n                        ").concat(closeIcon, "\n                    </span>\n                </li>\n            ");
...
function getCartPage() {
  ...
  if (data.products.length > 0) {
    ...
    for (var i = 0; i < data.products.length; i++) {
      ...
      var template = "\n                <div class=\"flat-card is-auto cart-card product-container\" data-product-id=\"".concat(data.products[i].id, "\">\n                    <ul class=\"cart-content\">\n                        <li>\n                            <img src=\"http://via.placeholder.com/500x500/ffffff/999999\"\n                                data-demo-src=\"").concat(data.products[i].images[0].url, "\" alt=\"\">\n                            <span class=\"product-info\">\n                                <span>").concat(data.products[i].name, "</span>\n                                <span>").concat(data.products[i].category, "</span>\n                            </span>\n                            <span class=\"product-price\">\n                                <span>Price</span>\n                                <span>").concat(parseFloat(data.products[i].price).toFixed(2), "</span>\n                            </span>\n\n                            <div data-trigger=\"spinner\" class=\"main-cart-spinner\">\n                                <input class=\"hidden-spinner\" type=\"hidden\" value=\"").concat(data.products[i].quantity, "\" data-spin=\"spinner\" data-rule=\"quantity\"\n                                    data-min=\"1\" data-max=\"99\">\n                                <a class=\"spinner-button is-remove\" href=\"javascript:;\" data-spin=\"down\">\n                                    ").concat(minusIcon, "\n                                </a>\n                                <span class=\"spinner-value\">").concat(data.products[i].quantity, "</span>\n                                <a class=\"spinner-button is-add\" href=\"javascript:;\" data-spin=\"up\">\n                                    ").concat(plusIcon, "\n                                </a>\n                            </div>\n\n                            <span class=\"action\">\n                                <span class=\"action-link is-remove remove-from-cartpage-action has-simple-popover\" data-content=\"Remove from Cart\"\n                                    data-placement=\"top\" onclick=\"return false\">\n                                    <a href=\"#\">").concat(removeIcon, "</a>\n                                </span>\n                            </span>\n                        </li>\n                    </ul>\n                </div>\n            ");
