...
function getCheckoutSidebar() {
  ...
  $('#checkout-avatar').attr('data-demo-src', checkout.avatar); //DEMO
...
function getCheckoutStep1() {
  ...
  for (var p = 0; p < checkout.items.length; p++) {
    var template = "\n            <div class=\"flex-table-item product-container\" data-product-id=\"".concat(checkout.items[p].id, "\">\n                <div class=\"product\">\n                    <img src=\"http://via.placeholder.com/250x250\" data-demo-src=\"").concat(checkout.items[p].images[0].url, "\" alt=\"\">\n                    <a class=\"product-name\">").concat(checkout.items[p].name, "</a>\n                </div>\n                <div class=\"quantity\">\n                    <span>").concat(checkout.items[p].quantity, "</span>\n                </div>\n                <div class=\"price\">\n                    <span class=\"has-price\">").concat(checkout.items[p].price.toFixed(2), "</span>\n                </div>\n                <div class=\"discount\">\n                    <span class=\"has-price\">0</span>\n                </div>\n                <div class=\"total\">\n                    <span class=\"has-price\">").concat((checkout.items[p].price * checkout.items[p].quantity).toFixed(2), "</span>\n                </div>\n            </div>\n        ");
